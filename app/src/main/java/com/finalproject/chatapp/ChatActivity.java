...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ReciverImage = getIntent().getStringExtra("ReceiverImage");
        ReciverUID = getIntent().getStringExtra("uid");

        messagesArrayList = new ArrayList<>();

        profileImage = findViewById(R.id.receiver_image);
        reciverName = findViewById(R.id.receiver_name);
        messageAdater = findViewById(R.id.messageAdapter);

        messagesArrayList = new ArrayList<>();
        adater = new MessageAdapter(ChatActivity.this, messagesArrayList);
        ...
        edtMessage = findViewById(R.id.user_message);
        ...
        chatRefrece.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    com.finalproject.chatapp.Messages messages = dataSnapshot.getValue(com.finalproject.chatapp.Messages.class);
        ...
        sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                com.finalproject.chatapp.Messages messages = new com.finalproject.chatapp.Messages(message, SenderUID, date.getTime());
